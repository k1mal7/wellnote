  ...
  return (
    <div className="grid items-start gap-5 lg:grid-cols-2">
      <section className={card}>
        ...
        </li>)}</ul> : <p className="mt-4 rounded-xl bg-slate-50 p-4 text-sm text-slate-500">No repeated measures yet.</p>}
      ...
      <section className={card}>
        ...
        </div> : <p className="mt-4 text-sm text-slate-500">No finalized visits yet.</p>}
      </section>
